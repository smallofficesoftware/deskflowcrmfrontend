    ...
    >
      <div className="content" id="content">
        ...
        <table className="print-table">
          ...
          <tbody>
            {printSetting?.setting_details.contactDetails == true && (
              <><tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style={{ textAlign: "right", verticalAlign: "top", padding: "4px 0" }}>
                            {accountTransactions.item[0].customer_name?.person_name || "-"}
                          </td>
                        </tr>
                        <tr>
                          <td style={{ verticalAlign: "top", padding: "4px 6px 4px 0", fontWeight: "bold" }}>
                          ...
                          <td style={{ textAlign: "right", verticalAlign: "top", padding: "4px 0" }}>
                            {accountTransactions.item[0].customer_name?.mobile_number || "-"}
                          </td>
                        </tr>

                        {accountTransactions.item[0].customer_name?.company_name && <tr>
                          <td style={{ verticalAlign: "top", padding: "4px 6px 4px 0", fontWeight: "bold" }}>
                            Company Name:
                          </td>
                          <td style={{ textAlign: "right", verticalAlign: "top", padding: "4px 0" }}>
                            {accountTransactions.item[0].customer_name?.company_name || "-"}
                          </td>
                        </tr>}
                        {accountTransactions.item[0].customer_name?.country_name && <tr>
                          <td style={{ verticalAlign: "top", padding: "4px 6px 4px 0", fontWeight: "bold" }}>
                            Country:
                          </td>
                          <td style={{ textAlign: "right", verticalAlign: "top", padding: "4px 0" }}>
                            {accountTransactions.item[0].customer_name?.country_name || "-"}
                          </td>
                        </tr>}
                        {accountTransactions.item[0].customer_name?.state_name && <tr>
                          <td style={{ verticalAlign: "top", padding: "4px 6px 4px 0", fontWeight: "bold" }}>
                            State:
                          </td>
                          <td style={{ textAlign: "right", verticalAlign: "top", padding: "4px 0" }}>
                            {accountTransactions.item[0].customer_name?.state_name || "-"}
                          </td>
                        </tr>}
                        {accountTransactions.item[0].customer_name?.city_name && <tr>
                          <td style={{ verticalAlign: "top", padding: "4px 6px 4px 0", fontWeight: "bold" }}>
                            City:
                          </td>
                          <td style={{ textAlign: "right", verticalAlign: "top", padding: "4px 0" }}>
                            {accountTransactions.item[0].customer_name?.city_name || "-"}
                          </td>
                        </tr>}
                        {accountTransactions.item[0].customer_name?.pincode && <tr>
                          <td style={{ verticalAlign: "top", padding: "4px 6px 4px 0", fontWeight: "bold" }}>
                            Pincode:
                          </td>
                          <td style={{ textAlign: "right", verticalAlign: "top", padding: "4px 0" }}>
                            {accountTransactions.item[0].customer_name?.pincode || "-"}
                          </td>
                        </tr>}
                        {accountTransactions.item[0].customer_name?.address && <tr>
                          <td style={{ verticalAlign: "top", padding: "4px 6px 4px 0", fontWeight: "bold" }}>
                            Address:
                          </td>
                          <td style={{ textAlign: "right", verticalAlign: "top", padding: "4px 0" }}>
                            {accountTransactions.item[0].customer_name?.address || "-"}
                          </td>
                        </tr>}
              ...
              <td className="main-colspan-class" style={{ padding: "0" }} colSpan={4}>
                <table border={0} style={{ width: "100%", border: "0" }}>
                  <tbody>
                    ...
                    <tr>
                      <td style={{ textAlign: "left", verticalAlign: "top", padding: "6px 0 4px 0", fontWeight: "bold", color: "#1b1bb3" }}>
                        <SafeHtml
...
export default AccountPrintView1;
