...
// Inward (cart type 8) is pdfme-supported - same shape as
...
export const isPdfmeEnabledForInward = async (): Promise<boolean> => {
  if (!isPdfmeSupportedCartType(8)) return false;
...
export const fetchInwardPdfmeTemplates = () => fetchPdfmeTemplatesForPicker(8);
...
export const generateAndPrintInwardPdf = async (
...
export const fetchInwardReportForExport = async (
  selectedDates: any,
  selectedTeamMembers: string[] | null,
  selectedStageStatus?: string[] | null,
  MobileToken?: string,
...
export const exportAllInwardData = async <T>(
