...
import { fetchCitiesApi, fetchCountriesApi, fetchStatesApi, handleDeleteCities, ICitiesView, ICountriesView, IStatesView } from "../../../left-side/header/Setting/cities/CitiesController";
    ...
    useEffect(() => {
        if (canView) {
            const fetchCities = async () => {
                ...
                if (targetCountryId && targetStateId) {
...
export default AllCitiesReport;