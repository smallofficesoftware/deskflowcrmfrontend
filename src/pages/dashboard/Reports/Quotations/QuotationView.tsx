...
`
  ...
  const exportExcel = async () => {
    try {
      ...
      const exportData = await exportAllQuotationData<IFlatCartItem>(
      ...
      const excelRows = (
        ...
        const row: any = {
          ...
          "Quotation Number": item.cart_number || "XXXXXXX",
      ...
      xlsx.utils.book_append_sheet(wb, ws, "Quotation Report");
      ...
      saveAs(
        ...
        `quotation_report_${Date.now()}.xlsx`,
      );
              ...
              <Column
                ...
                body={(row) => (
                  <span
                    ...
                    onClick={() =>
                      !MobileFlag && handelChangeShowModelQuotation(row)
                    }
                  >
