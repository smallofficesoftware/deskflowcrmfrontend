...
const TeamSalesInvoiceDataReportsView = ({
  ...
  const exportColumns = [
    ...
    { title: "Customer GST No.", dataKey: "gst_number" },
    ...
    try {
      ...
      const excelRows = (
        ...
        const row: any = {
          ...
          "Invoice Number": item.cart_number || "XXXXXXX",
          ...
          "Customer GST No.": item.gst_number || "-",
          "Created By": item.username || "-",
          // type: title || "Sales Invoice",
              ...
              <Column
                ...
                body={(rowData: any) => (
                  <span
                    ...
                    // onClick={
                    //   !MobileFlag ? () => handelChangeShowModesalesInvoice(rowData) : undefined
                    // }
