...
// Left-rail step nav — mirrors the approved wizard mock's rail exactly
// (step buttons + an "Advanced mode" toggle at the bottom), rebuilt as a
// real component instead of the mock's vanilla-JS render function since
// this now drives actual React state (ReportBuilderWizardView.tsx).
const WizardRail: React.FC<WizardRailProps> = ({ steps, activeStep, furthest, notApplicableSteps, advanced, onAdvancedChange, onGoto }) => (
  <nav style={{ width: 240, flexShrink: 0, display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
