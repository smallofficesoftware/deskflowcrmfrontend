            ...
            >
              <Container fluid className="mt-2">
                ...
                {loading ? (
                  ...
                  <>
                    <Row className="mb-2 d-flex align-items-stretch">
                      {[
                        {
                          count: totalContact,
                          title: "Total Contact",
                        ...
                        <Col md={2} key={idx}>
                          ...
                          >
                            <Card.Body className="d-flex flex-column justify-content-between align-items-end text-end">
                              ...
                              <h4 className="dash-board-text">{item.title}</h4>
                            </Card.Body>
                          </Card>
                        </Col>
                      ))}
                    ...
                    <Row className="mb-2">
                      <Col md={6}>
                        <Card
                          ...
                          style={{ height: "300px", borderRadius: "0px" }}
                        >
                          <Card.Body>
