...
const OrderPrintViewV3 = () => {
  ...
  const [canPdfReturnSalesInvoice, setcanPdfReturnSalesInvoice] =
    useState<boolean>(false);
  const [canPdfReturnPurchaseInvoice, setcanPdfReturnPurchaseInvoice] =
    useState<boolean>(false);
  ...
  const loadRights = async () => {
    ...
    const response10 = await newRightsForPrint(
      PAGE_ID.RETURN_PURCHASE_INVOICE,
      a_application_login_id,
    );
    setcanPdfReturnPurchaseInvoice(response10?.share);
  ...
  useEffect(() => {
    if (printSetting?.setting_details?.productImage) {
      const isPrint = printSetting.setting_details?.productImage === true;
...
${printSetting?.setting_details.productImageinColumn &&
                  ...
                  ? `
    .print-table th:nth-child(1) { width: 3% !important; } /* No. */
    .print-table th:nth-child(2) { width: 4% !important; } /* Image */
    .print-table th:nth-child(3) { width: 21% !important; } /* Product Description */
    .print-table th:nth-child(4) { width: 8% !important; } /* HSN/SAC */
    .print-table th:nth-child(5) { width: 12% !important; } /* Qty/Unit */
    .print-table th:nth-child(6) { width: 10% !important; } /* Rate */
    .print-table th:nth-child(7) { width: 10% !important; } /* Dis(%) */
    .print-table th:nth-child(8) { width: 12% !important; } /* GST(%) */
    .print-table th:nth-child(9) { width: 18% !important; } /* Amount */
    `
                  : `
    .print-table th:nth-child(1) { width: 3% !important; } /* No. */
    ...
    .print-table th:nth-child(5) { width: 10% !important; } /* Rate */
    .print-table th:nth-child(6) { width: 10% !important; } /* Dis(%) */
    .print-table th:nth-child(7) { width: 12% !important; } /* GST(%) */
    .print-table th:nth-child(8) { width: 18% !important; } /* Amount */
    `
                }
    ...
    .print-table.no-gst th:nth-child(2) { width: 5% !important; }
    .print-table.no-gst th:nth-child(3) { width: 25% !important; }
    .print-table.no-gst th:nth-child(4) { width: 15% !important; }
    .print-table.no-gst th:nth-child(5) { width: 15% !important; }
    .print-table.no-gst th:nth-child(6) { width: 10% !important; }
    .print-table.no-gst th:nth-child(7) { width: 20% !important; }
    `
                  : `
    .print-table.no-gst th:nth-child(1) { width: 5% !important; }
    .print-table.no-gst th:nth-child(2) { width: 30% !important; }
        ...
        `}
            ...
            <div className="print-table">
              <div className="content" id="content">
                <table
                  className={`print-table ${orderPrintById.cart.gst_amt == 0 ? "no-gst" : ""
                    }`}
                            ...
                            <React.Fragment key={index}>
                              ...
                              >
                                ...
                                {printSetting?.setting_details.rate && (
                                  <>
                                    <td
                                      className={`text-right now-rap-white-space currency-amount ${showBorder ? "no-print-border" : ""
                                        }`}
                                      colSpan={
                                        printSetting?.setting_details
                                          .discountColumn == true
                              ...
                              {printSetting?.setting_details.rate && (
                                <>
                                  ...
                                  <td
                                    ...
                                    colSpan={
                                      printSetting?.setting_details.gstColumn ==
                                        true && orderPrintById.cart.gst_amt != 0
                                        ? 1
                                        : 2
                                    }
                                  ></td>
                          ...
                          <tbody>
                            <tr>
                              ...
                              >
                                ...
                                >
                                  {printSetting?.setting_details.rate &&
                                    orderPrintById?.cart.total_amt != 0 &&
                                    orderPrintById?.cart.total_amt != null &&
                                  ...
                                  <>
                                    {activeRows.map((row) => (
                                      <tr key={row.key}>
                                        ...
                                        <td
                                          className={`text-right now-rap-white-space font-13 without_price_check  ${showBorder ? "no-print-border" : ""
                                            }`}
                                    ...
                                    {Array.from({
                                      ...
                                      <tr key={`blank-${index}`}>
                                        ...
                                        ></td>
                                        <td
                                          className={`text-right font-13 without_price_check  ${showBorder ? "no-print-border" : ""
                                            }`}
                                          style={{ borderRight: "0px" }}
                                        ></td>
                                      </tr>
                                    ...
                                    <tr className="without_price_check">
                                      ...
                                      ></td>
                                      <td
                                        className={`text-right  ${showBorder ? "no-print-border" : ""
                                          }`}
                                      >
                            ...
                            <tr className="without_price_check">
                              ...
                              >
                                {printSetting?.setting_details.note && (
                                  <b>Note : {orderPrintById.cart.cart_note}</b>
                                )}
                              </td>
                              {printSetting?.setting_details.rate && (
                                <>
                                  ...
                                  <td
                                    className="text-right now-rap-white-space currency-amount"
                                    style={{
                                      fontSize: "10px",
                                      borderBottom: "0px",
                                      borderRight: "0px",
                                                ...
                                                hasTransportChargeWithHsn) && (
                                                  <tr>
                                                    ...
                                                    {orderPrintById?.cart
                                                      ...
                                                      <>
                                                        <td
                                                          className={`text-right font-13 without_price_check_customer`}
                                                        ></td>
                                                        <td
                                                          className={`text-right now-rap-white-space font-13 without_price_check `}
                                                        >
...
export default OrderPrintViewV3;
