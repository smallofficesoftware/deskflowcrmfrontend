...
import CustomerSupportListStatusTable from "./CustomerSupportListStatusTable";
...
const CustomerSupportListView = ({
  ...
  const [isCompleteStatus, setIsCompleteStatus] = useState<number>();
  ...
  return (
    <div style={{ padding: "10px", width: "70vw", height: "100vh" }}>
      <div className="card w-100 h-100">
                    ...
                    <td style={{ width: "12vw" }}>
                      ...
                      <div
                        ...
                        onClick={() => {
                          ...
                          setIsCompleteStatus(ticket.status);
                        }
                        }
                        onMouseEnter={(e) => {
        ...
        {showStatus && (
          <CustomerSupportListStatusTable
            show={showStatus}
...
export default CustomerSupportListView;