...
import { fetchNameAndNumber } from "../customer-support-form/CustomerSupportFormController";
import { createSupportTicket, fetchCategoryApiForProduct } from "./CustomerSupportFormController";
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="d-flex gap-2">
                            ...
                            <button
                                type="submit"
                                className="btn"
                                style={{ backgroundColor: "#F38534", color: "white", width: fullWidth ? "49%" : "100%" }}
                                disabled={loading}
