...
const SidebarView = ({
  ...
  return (
    ...
    >
        ...
        >
          ...
          {isOpen ? (
            <>
              ...
              >
                <img src={deshFlow_log_icon} alt="logo" width={150} />
              </div>
            ...
            <>
              {!isHovered ? (
                ...
                >
                  <img src={smalll_office_logo} alt="logo" width={26} />
                </div>
              ) : (
                <button
      ...
      <hr style={{ borderColor: "#5a5a5a", margin: "10px 0" }} />
        ...
        {filteredMenus.map((menu: any) => (
          <div key={menu.key}>
            ...
            >
              ...
              >
                <span style={{ color: "#ffffff" }}>{menu.icon}</span>
                    ...
                    style={{
                      ...
                      background:
                        activeReport === sub.value
                          ? "rgba(245, 134, 52, 0.18)"
                          : hoveredSubMenu === sub.label
                            ? "rgba(255, 255, 255, 0.08)"
                            : "transparent",
                      color: activeReport === sub.value ? "#f58634" : "#e5e7eb",
                      borderLeft: activeReport === sub.value ? "3px solid #f58634" : "3px solid transparent",
                      borderRadius: "8px",
                      marginBottom: "3px",
                      transition: "0.2s",
                      fontWeight: activeReport === sub.value ? "600" : "400",
                    }}
                    onClick={() => {
                      if (sub.value) {
